class Ysh < Formula
  ...
  url "https://github.com/azohra/yaml.sh/releases/download/v1.16.0/ysh", using: :nounzip
  sha256 "70b2209667a6987dc09b72c8450b64eeab985d76edfa3138109b2f8410789dca"
  license "MIT"
